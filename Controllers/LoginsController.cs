...
namespace OkitechWebApp.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public LoginsController(OkitechWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Login != null ? 
                          ...
                          Problem("Entity set 'OkitechWebAppContext.Login'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'OkitechWebAppContext.Login'  is null.");
            }
            var login = await _context.Login.FindAsync(id);
            if (login != null)
            {
        ...
        {
          return (_context.Login?.Any(e => e.Username == id)).GetValueOrDefault();
        }
    }
}
